...
<head>
    ...
    <meta name="description"
        content="Yuntas Producciones. Somos una empresa creativa dedicada a la decoración de espacios con luces LED de última tecnología perfectos para la publicidad de tu negocio.">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta http-equiv="Content-Security-Policy" content="upgrade-insecure-requests">

    <meta name="keywords"
        content="Yuntas Producciones, luces led,letrero led, yuntas,pantallas led,calidad de imagen,efectos 3d led,Neon Led,luces navideñas,iluminación led, yuntas producciones,barras luces led, ventilador holografico, holograma 3d, publicidad,marketing, luces led de colores,luces led navidad">
        ...
        <div class="slider">
            <div id="carouselExampleIntervals" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-indicators">
                    <button type="button" data-bs-target="#carouselExampleIntervals" data-bs-slide-to="0" class="active"
                        aria-current="true" aria-label="Slide 1"></button>
                    <button type="button" data-bs-target="#carouselExampleIntervals" data-bs-slide-to="1"
                        aria-label="Slide 2"></button>
                    <button type="button" data-bs-target="#carouselExampleIntervals" data-bs-slide-to="2"
                ...
                <ul class="ul_categorias">
                    <li class="li">
                        <a href="producto?slug=Pantalla Led">
                            <img width='60' height='50' src="public/img/icons_categorias/001.png" class="img_one"
                                alt="">
                    ...
                    <li class="li">
                        <a href="producto?slug=Ventilador holográfico">
                            <img width='50' height='50' src="public/img/icons_categorias/002.png" class="img_one"
                                alt="">
                    ...
                    <li class="li">
                        <a href="producto?slug=Letreros neón led">
                            <img width='50' height='50' src="public/img/icons_categorias/003.png" class="img_one"
                                alt="">
                    ...
                    <li class="li">
                        <a href="producto?slug=Cubo Led">
                            <img width='50' height='50' src="public/img/icons_categorias/004.png" class="img_one"
                                alt="">
                    ...
                    <li class="li">
                        <a href="producto?slug=Relojes digitales">
                            <img width='100' height='50' src="public/img/icons_categorias/005.png" class="img_one"
                                alt="">
                            <img width='100' height='50' src="public/img/icons_categorias/50.png" class="img_two"
                                alt="">
                            <span>
                                Relojes Digitales
                            </span>
                    ...
                    <li class="li">
                        <a href="producto?slug=Letreros led">
                            <img width='50' height='50' src="public/img/icons_categorias/006.png" class="img_one"
                                alt="">
    ...
    <div class="container-sm my-5">
        <div style="margin:0 auto;" class="row ">
            <div class="col-lg-4 col-md-6">
                <a href="producto?slug=Pantalla Led">
                    <img style="width: 100%;height:308px;object-fit: cover; border-radius: 30px;"
                        src="views/assets/pantallasled.webp" alt="enlaces">
            ...
            <div class="col-lg-4 col-md-6">
                <a href="producto?slug=Ventilador holográfico">
                    <img style="width: 100%;height:308px;object-fit: cover; border-radius: 30px;"
                        src="views/assets/efectos3d.webp" alt="enlaces">
            ...
            <div class="col-lg-4 col-md-6">
                <a href="producto?slug=Letreros neón led">
                    <img style="width: 100%;height:308px;object-fit: cover; border-radius: 30px;"
                        src="views/assets/letrerosneonled.webp" alt="enlaces">
            ...
            <div class="col-lg-4 col-md-6">
                <a href="producto?slug=Cubo Led">
                    <img style="width: 100%;height:308px;object-fit: cover; border-radius: 30px;"
                        src="views/assets/cubosled.webp" alt="enlaces">
            ...
            <div class="col-lg-4 col-md-6">
                <a href="producto?slug=Relojes digitales">
                    <img style="width: 100%;height:308px;object-fit: cover; border-radius: 30px;"
                        src="views/assets/relojesdigitales.webp" alt="enlaces">
            ...
            <div class="col-lg-4 col-md-6">
                <a href="producto?slug=Letreros led">
                    <img style="width: 100%;height:308px;object-fit: cover; border-radius: 30px;"
                        src="views/assets/letrerosled.webp" alt="enlaces">
