  ...
  <body>
        ...
        <div id="carouselExampleIntervals" class="carousel slide" data-bs-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active" data-bs-interval="2000">
              <img src="public/productos_neon_led/neon_led_1.jpg" class="d-block w-100" alt="slide1">
            </div>
            <div class="carousel-item" data-bs-interval="2000">
              <img src="public/productos_neon_led/neon_led_2.webp" class="d-block w-100" alt="slide2">
            </div>
            <div class="carousel-item" data-bs-interval="2000">
              <img src="public/productos_neon_led/neon_led_3.webp" class="d-block w-100" alt="slide3">
            </div>
          </div>
    ...
    <div class="info-2 info-2-first">
      <div class="titulos2-container">  
        <h1 class="titulos2">¿Dondé puedes usar un letrero de neon led?</h1>
      </div>
