  ...
  <body>
    ...
    <div class="info-2 info-2-first">
      <div class="titulos2-container">  
        <h1 class="titulos2">¿Dondé puedes usar una pantalla led?</h1>
      </div>
      ...
      <div class="container row" style="margin: auto;">
        <div class="col-lg-4 col-md-6 col">
          <a href="pantallas_led">
            <img style="<?=$style_img_info?>" src="public/pantallas_led/pantalla-led-interior-2.jpg" alt="enlaces">
            <h2 class="subtitulo2">Interiores y exteriores</h2>
          </a>
        </div>
          
        <div class="col-lg-4 col-md-6 col">
          <a href="efectos3d">
            <img style="<?=$style_img_info?>" src="public/pantallas_led/valla-publicitaria.webp" alt="enlaces">
            <h2 class="subtitulo2">Vallas publicitarias</h2>
          </a>
        </div>

        <div class="col-lg-4 col-md-6 col">
          <a href="letreros_neon_led">
            <img style="<?=$style_img_info?>" src="public/pantallas_led/compra-y-venta-de-pantallas-publicitarias-led.jpg" alt="enlaces">
            <h2 class="subtitulo2">Pantallas informativas</h2>
          </a>
        </div>

        <div class="col-lg-4 col-md-6 col">
          <a href="cubos_led">
            <img style="<?=$style_img_info?>" src="public/pantallas_led/pantalla-led-gigante.jpg" alt="enlaces">
            <h2 class="subtitulo2">Pantallas gigantes</h2>
          </a>
        </div>
            
        <div class="col-lg-4 col-md-6 col">
          <a href="relojes_digitales">
            <img style="<?=$style_img_info?>" src="public/pantallas_led/panel-informativo.jpg" alt="enlaces">
            <h2 class="subtitulo2">Paneles informativos</h2>
          </a>
        </div>
      </div>
    </div>
